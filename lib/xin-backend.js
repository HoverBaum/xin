'use strict'
var startUbiquitous = require('./xin-ubiquitous-backend');
module.exports = startUbiquitous;
 ...
 *   @global
 */
global.subscribe = function(channel, callback) {
 ...
 *   @global
 */
global.emit = function(channel, event) {
